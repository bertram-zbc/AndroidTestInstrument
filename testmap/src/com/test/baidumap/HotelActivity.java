...
public class HotelActivity extends Activity implements OnItemClickListener,OnScrollListener {
		...
		OnGetPoiSearchResultListener poiListener = new OnGetPoiSearchResultListener() {
			...
			public void onGetPoiResult(PoiResult result) {
				if (result == null
					...
					Toast.makeText(HotelActivity.this, "未找到结果", Toast.LENGTH_LONG)
					.show();
					return;
				}
				if (result.error == SearchResult.ERRORNO.AMBIGUOUS_KEYWORD) {
					...
					strInfo += "找到结果";
					Toast.makeText(HotelActivity.this, strInfo, Toast.LENGTH_LONG)
							.show();
				}
				poiResult = result;
			...
			public void onGetPoiDetailResult(PoiDetailResult result) {
				...
				if (result.error != SearchResult.ERRORNO.NO_ERROR) {
					Toast.makeText(HotelActivity.this, "抱歉，未找到结果", Toast.LENGTH_SHORT)
							.show();
				} 
				else {
	...
	private void nameToGrocode() {
		...
		OnGetGeoCoderResultListener listener = new OnGetGeoCoderResultListener() {
			...
			public void onGetGeoCodeResult(GeoCodeResult result) {
				if (result == null || result.error != SearchResult.ERRORNO.NO_ERROR) {  
		            //没有检索到结果  
					Toast.makeText(HotelActivity.this, "暂无搜索信息", Toast.LENGTH_SHORT).show();
					return;
		        }  
		        //获取地理编码结果  
...
//	}
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
		...
		Intent intent = new Intent(HotelActivity.this,WebViewActivity.class);
