...
import com.test.baidumap.RegisterActivity;
...
public class RefreshListView extends ListView implements OnScrollListener {  
    ...
    boolean isRemark = false;// 标记，当前是在listview最顶端摁下的；  
    int startY;// 摁下时的Y值；  
    ...
    ILoadMoreDataListener iLoadMoreDataListener;
    ...
    public void onScrollStateChanged(AbsListView view, int scrollState) {  
    	...
    	if (scrollState == OnScrollListener.SCROLL_STATE_IDLE) {
            iLoadMoreDataListener.loadMoreData(moreView, lastItem);  
        }
    }  
    ...
    public void setInterface(IRefreshListener iRefreshListener, ILoadMoreDataListener iLoadMoreDataListener){  
