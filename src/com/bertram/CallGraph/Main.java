...
public class Main {
	...
	private final static String appApk="./втсипп.apk";
	public static void initialiseSoot()
	{
		...
		//Options.v().set_main_class("com.test.baidumap.StartActivity");
	...
	public static void main(String[] args)
	{
		...
		PackManager.v().getPack("jtp").add(new Transform("jtp.AndroidCFG", new CallGraphAnalysis()));
