...
public class CallFlowGraphSimplify {
	...
	private static String androidJAR = "E:/Android Analysis/soot-test-android/lib/android.jar";
	private static String appApk = "./testApp.apk";
	
	public static void main(String[] args) {
		File f = new File(appApk);
		String source_apk = f.getAbsolutePath();
		soot.G.reset();

		SetupApplication app = new SetupApplication(
		// "C:/Users/hao/Downloads/android-sdk-windows/platforms",
				androidJAR, source_apk);
